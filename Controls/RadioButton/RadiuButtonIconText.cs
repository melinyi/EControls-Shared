...
namespace EControl.Controls
{
    ...
    public class RadiuButtonIconText : RadioButton
    {
        public RadiuButtonIconText()
        {

            var tempLateStr = @"<ControlTemplate TargetType='RadioButton' xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation'>
                    <Border 
        ...
        public static readonly DependencyProperty IconProperty =
            DependencyProperty.Register("Icon", typeof(string), typeof(RadiuButtonIconText), new PropertyMetadata(""));
        ...
        public static readonly DependencyProperty IconForegroundProperty =
            DependencyProperty.Register("IconForeground", typeof(Brush), typeof(RadiuButtonIconText), new PropertyMetadata(Brushes.Black));
        ...
        public static readonly DependencyProperty IconFontSizeProperty =
            DependencyProperty.Register("IconFontSize", typeof(double), typeof(RadiuButtonIconText), new PropertyMetadata(20d));
        ...
        public static readonly DependencyProperty IconMarginProperty =
            DependencyProperty.Register("IconMargin", typeof(Thickness), typeof(RadiuButtonIconText), new PropertyMetadata(new Thickness(5)));
        ...
        public static readonly DependencyProperty ContentMarginProperty =
            DependencyProperty.Register("ContentMargin", typeof(Thickness), typeof(RadiuButtonIconText), new PropertyMetadata(new Thickness(5)));
        ...
        public static readonly DependencyProperty IconFontFamilyProperty =
            DependencyProperty.Register("IconFontFamily", typeof(FontFamily), typeof(RadiuButtonIconText), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty BorderRadiusProperty =
            DependencyProperty.Register("BorderRadius", typeof(CornerRadius), typeof(RadiuButtonIconText), new PropertyMetadata(new CornerRadius(0d)));
